...
function init() {
     ...
     //add event listener to every SVG path
     ...
     //add event listener to every SVG rectangle
     ...
     const menudiv = document.getElementById('uiDiv');
     $(document).on("mousenter", menudiv, function(){
          if ('speechSynthesis' in window) {
